...
import 'package:card_project/clients/ui/post_details/card_post_details.dart';
...
class PostList extends StatefulWidget {
  String IdCliente;
  PostList(this.IdCliente);

  @override
  State<PostList> createState() => _PostListState(IdCliente);
}
                  ...
                  child: Container(
                    ...
                    child: FlatButton(
                      ...
                      onPressed: () {
                        ...
                        var img;
                        var IdCliente = widget.IdCliente;
